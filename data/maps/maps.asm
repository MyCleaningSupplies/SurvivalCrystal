...
MapGroup_WaveringFalls:
	map WaveringFallsOutside, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WaveringFalls1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_CELESTIAL_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map WaveringFalls2F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_CELESTIAL_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
