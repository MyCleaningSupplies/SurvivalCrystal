...
MapGroup_WaveringFalls:
	...
	map WaveringFalls1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map WaveringFalls2F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
